...
// Keep the authenticated session cookie SameSite=Lax. OAuth flow cookies use
// SameSite=None because they must survive the cross-site redirect from
// accounts.google.com back to the application. All cookies are httpOnly and
